...
public class LegacyServiceTest {
    ...
    public void testCollaboratorsGettingLegacyList() throws ListNotFoundException {
        ...
        assertThat(dataListRecord.getTopicListItems()).hasOnlyElementsOfType(TopicEntityRecord.class);
        assertThat(dataListRecord.getTopicListItems()).hasSize(1);
        assertThat(dataListRecord.getTopicListItems().get(0).getName()).isEqualTo("Text");
        assertThat(dataListRecord.getTopicListItems().get(0).getCaseType()).isEqualTo("CaseValue");
